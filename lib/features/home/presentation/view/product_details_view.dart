...
//         int id = cacheData.getID();
//         String name = cacheData.getName();
//         String price = cacheData.getPrice();
//         String image = cacheData.getImage();
//         int index = cacheData.getIndex();
//         print(id);
//         print(controller.favorites[id]);
//
//         return willPopScope(
//           back: false,
//           child: Scaffold(
...
//                       color: controller.homeDataModel!.products![index]
